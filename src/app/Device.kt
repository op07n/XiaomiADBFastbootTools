...
class Device {
    ...
    fun readADB(): Boolean {
        ...
        bootloader = comm.exec("adb shell getprop ro.boot.flash.locked", false).contains("0") || comm.exec("adb shell getprop ro.secureboot.lockstate", false).contains("unlocked")
        anti = -1
        if (!recovery) {
