...
Yes, the Xiaomi ADB/Fastboot Tools was developed in Kotlin for the Java Virtual Machine so it needs the JRE to run. You can install the latest Oracle JRE from [here](https://java.com/en/download/).
